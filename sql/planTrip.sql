...
--     JOIN Stops s2 ON (st2.stop_id = s2.stop_id)
--   WHERE
--     s1.stop_name = "R. Da Cooperação, 32" AND s2.stop_name = "R. Vale Do Sol, 105"
--     AND (TIME_TO_SEC(st1.departure_time)-TIME_TO_SEC("18:30:00"))>=0 
--     AND (TIME_TO_SEC(st1.departure_time)-TIME_TO_SEC("18:30:00"))<=3600
--     AND st1.stop_sequence < st2.stop_sequence
--   ORDER BY (arrival_t - departure_t) ASC;